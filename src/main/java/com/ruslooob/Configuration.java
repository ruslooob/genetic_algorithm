...
public class Configuration {
    ...
    public static final double CONVERGENT_THRESHOLD = 0.000_001;
    // Вероятность мутации
    ...
    public static final DoubleInterval X_INTERVAL = new DoubleInterval(-10, 10);
    // Интервал, на котором будет происходит поиск по Y
    public static final DoubleInterval Y_INTERVAL = new DoubleInterval(-10, 10);
    // Точность, которая достигается делением интврала на части. Используется при кодировании чисел с плавающей точкой
    public static final double PRECISION = 0.000_001;
